...
- Cartesia phone audio is forwarded incrementally as raw 8 kHz mu-law. OpenAI connects during the opening; responses are requested after a completed caller turn. Brief listening acknowledgements do not clear the pitch, while meaningful or sustained speech can interrupt. A normal hangup drains queued speech and the farewell; opt-out stops the pitch immediately once recognized.
