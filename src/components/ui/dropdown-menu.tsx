...
// Base UI implementation (https://ui.shadcn.com/docs/components/base/dropdown-menu),
// restyled to match this app's new-york theme. Export names and the Content
// align/side/sideOffset props mirror the previous Radix wrapper; the one API
// difference for consumers is the trigger: Base UI uses `render={<Button/>}`
// instead of `asChild`, and keep-open items use `closeOnClick={false}` instead
// of `onSelect` + preventDefault.
