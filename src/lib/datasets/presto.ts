...
const PRESTO_EVENTS: EventDefinition[] = [
  // ── Acquisition (installs — one row per player, real per-install date) ──
  {
    id: "install",
    displayName: "Install",
    ...
    properties: [
      ...
      { column: "device_model", displayName: "Device Model", type: "string", cardinalityHint: "medium" },
      { column: "engagement_tier", displayName: "Engagement Tier", type: "string", cardinalityHint: "low" },
      { column: "is_new_targeting", displayName: "New Targeting (FB 5-game)", type: "string", cardinalityHint: "low" },
      { column: "is_fraud", displayName: "Fraud Flag", type: "string", cardinalityHint: "low" },
      { column: "fraud_rate", displayName: "Fraud Rate", type: "number", cardinalityHint: "high" },
      { column: "install_week", displayName: "Install Week", type: "string", cardinalityHint: "medium" },
      { column: "install_month", displayName: "Install Month", type: "string", cardinalityHint: "low" },
    ],
  },
  // Derived install milestone: high-engagement installs (5+ games in first 7 days).
  // Backed by installs.engagement_tier — same table, filtered on the real column.
  {
    id: "high_engagement_install",
    displayName: "High-Engagement Install",
    category: "Acquisition",
    table: "installs",
    filterColumn: "engagement_tier",
    filterValue: "high",
    dateColumn: "install_date",
    funnelEligible: true,
    properties: [
  ...
  // ── Engagement (sessions — one row per active player-day, real session date) ──
  {
    id: "session",
    displayName: "Session",
    category: "Engagement",
    ...
    properties: [
      ...
      { column: "platform", displayName: "Platform", type: "string", cardinalityHint: "low" },
      { column: "country", displayName: "Country", type: "string", cardinalityHint: "medium" },
      { column: "days_from_install", displayName: "Days From Install", type: "number", cardinalityHint: "low" },
      { column: "session_duration_mins", displayName: "Session Duration (mins)", type: "number", cardinalityHint: "high" },
      { column: "level_reached", displayName: "Level Reached", type: "number", cardinalityHint: "medium" },
      { column: "level_completed", displayName: "Level Completed", type: "number", cardinalityHint: "medium" },
      { column: "is_fraud", displayName: "Fraud Flag", type: "string", cardinalityHint: "low" },
      { column: "install_week", displayName: "Install Week", type: "string", cardinalityHint: "medium" },
      { column: "install_month", displayName: "Install Month", type: "string", cardinalityHint: "low" },
    ],
  },
  // ── Ad Revenue (ad_impression_events — one row per impression, real ts) ──
  {
    id: "ad_impression",
    ...
    properties: [
      ...
      { column: "ad_platform", displayName: "Ad Network", type: "string", cardinalityHint: "low" },
      { column: "channel", displayName: "Acquisition Channel", type: "string", cardinalityHint: "low" },
      { column: "platform", displayName: "Platform", type: "string", cardinalityHint: "low" },
      { column: "country", displayName: "Country", type: "string", cardinalityHint: "medium" },
      { column: "fraud_rate", displayName: "Fraud Rate", type: "number", cardinalityHint: "low" },
      { column: "install_week", displayName: "Install Week", type: "string", cardinalityHint: "medium" },
      { column: "install_month", displayName: "Install Month", type: "string", cardinalityHint: "low" },
    ],
  },
  // Settled ad revenue: post-fraud payout measure on the same impression rows.
  // Backed by ad_impression_events.settled_revenue (0 for fraud users).
  {
    id: "settled_ad_revenue",
    displayName: "Settled Ad Revenue",
    category: "Ad Revenue",
    table: "ad_impression_events",
    valueColumn: "settled_revenue",
    dateColumn: "ts",
    funnelEligible: true,
    properties: [
      { column: "ad_format", displayName: "Ad Format", type: "string", cardinalityHint: "low" },
  ...
  // ── Monetization / Cohort revenue (revenue — cohort-level daily rollup) ──
  // Multiple period rows share one cohort_date and many are forward projections,
  // so this is NOT a real per-event timestamp → funnelEligible: false.
  {
    id: "cohort_revenue",
    displayName: "Cohort Revenue (LTV)",
    category: "Monetization",
    table: "revenue",
    valueColumn: "total_arpu",
    ...
    properties: [
      ...
      { column: "country", displayName: "Country", type: "string", cardinalityHint: "medium" },
      { column: "platform", displayName: "Platform", type: "string", cardinalityHint: "low" },
      { column: "os", displayName: "OS", type: "string", cardinalityHint: "low" },
      { column: "days_from_cohort", displayName: "Days From Cohort", type: "number", cardinalityHint: "low" },
      { column: "period", displayName: "Period", type: "string", cardinalityHint: "low" },
      { column: "is_observed", displayName: "Observed vs Projected", type: "string", cardinalityHint: "low" },
      { column: "install_week", displayName: "Install Week", type: "string", cardinalityHint: "medium" },
      { column: "install_month", displayName: "Install Month", type: "string", cardinalityHint: "low" },
    ],
  },
  // ── Acquisition spend (campaign — daily paid-channel spend rollup) ──
  // One row per (cohort_date, channel, country, os); a daily rollup, not a
  // per-event record → funnelEligible: false.
  {
    id: "campaign_spend",
    ...
    properties: [
      ...
      { column: "country", displayName: "Country", type: "string", cardinalityHint: "medium" },
      { column: "os", displayName: "OS", type: "string", cardinalityHint: "low" },
      { column: "installs", displayName: "Installs", type: "number", cardinalityHint: "high" },
      { column: "impressions", displayName: "Impressions", type: "number", cardinalityHint: "high" },
      { column: "clicks", displayName: "Clicks", type: "number", cardinalityHint: "high" },
      { column: "cpi", displayName: "CPI", type: "number", cardinalityHint: "high" },
      { column: "ecpm", displayName: "eCPM", type: "number", cardinalityHint: "high" },
    ],
  },
];

export const prestoDataset: DatasetConfig = {
  id: "presto",
  label: "Consumer Apps & Gaming",
  companyName: "Presto",
  dbFile: "data/presto.duckdb",
  sourceType: "duckdb",
...
spend-scenario|3| — Geo expansion: avg_projected_ltv at D14 vs D90 by country from ltv_by_cohort WHERE days_from_cohort IN (14,90)`,
  ...
  suggestedPrompts: [
    "Do higher-CPI channels actually deliver higher-LTV players?",
    "How much of our reported ad revenue has actually settled, by channel?",
    "Is ad revenue growing because we monetise better, or just because we have more users?",
    "Which acquisition channel has the best 90-day return on ad spend?",
    "How long do our recent cohorts take to pay back their acquisition spend?",
    "Is our 60-day LTV model still holding up against actual retention?",
    "How much stickier are our most engaged players in 60-day value?",
  ],

  welcomeSubtitle: "Explore CPI quality, fraud settlement, cohort LTV vs closed revenue, and UA spend scenarios for Presto.",
  ...
  viewSQL: (dataDir: string) => {
    const parquetDir = `${dataDir}/parquet/prestov2`;
    return [
