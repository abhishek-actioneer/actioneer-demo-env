...
- As of: 2026-05-08T07:00:43.174Z
- Synthesize: no (pass --synthesize)
- Output: `/Users/vimarsh/Documents/baby-sentinel/tmp/vastu-ir-pipeline/2026-05-08T07-00-43-171Z`
...
- [quarterly_results · FY26 Q4] Audited Financial Result for quarter and year ended 31st March 2026
  - _Latest Q4 audited results — full-year FY26_
...
- [annual_report · FY24] ANNUAL REPORT 2023-24
  - _Latest investor presentation / narrative_
...
- Total picked: **11** docs across 5 companies
- 0.0s

## Stage C — Extract (11 URLs in one batch call)
### Vastu Housing Finance
- 15,786 chars → `C-extract-vastu-housing-finance-1.md`
...
### Aavas Financiers
- 1,978 chars → `C-extract-aavas-financiers-1.md`
...
- 3,974 chars → `C-extract-aavas-financiers-2.md`
...
### Aptus Value Housing Finance
- 14,677 chars → `C-extract-aptus-value-housing-finance-1.md`
...
- 15,894 chars → `C-extract-aptus-value-housing-finance-2.md`
...
### Home First Finance
- 962 chars → `C-extract-home-first-finance-1.md`
...
- 19,814 chars → `C-extract-home-first-finance-2.md`
...
- 5,933 chars → `C-extract-home-first-finance-3.md`
...
---
Done. Open `tmp/vastu-ir-pipeline/2026-05-08T07-00-43-171Z/summary.md`
